...
namespace TestMVC.Models
{
    partial class DataPersonne : Component
    {
        ...
        public List<Personne> SelectAll()
        {
            ...
            sqlCommand1.CommandText = "select id, nom, prenom, age from personnes";
        ...
        public Personne SelectByRef(string Ref)
        {
            ...
            try
            {
                if (reader.Read())
                {
                    a = new Personne(reader.GetInt32(0), reader.GetString(1), reader.GetString(2), reader.GetInt32(3));
                }
            }
            catch
            {
        ...
        public void Update(Personne a)
        {
            sqlConnection1.Open();
            sqlCommand1.CommandText = "update articles set marque = '" + a.Nom + "' , prix = " + a.Prenom + " where ref = "+ a.Id;
            sqlCommand1.ExecuteNonQuery();
            sqlConnection1.Close();
        }
        ...
        public Personne SelectById(int id)
        {
            ...
            sqlConnection1.Open();
            sqlCommand1.CommandText = "select * from personnes where id = " + id;
            SqlDataReader reader = sqlCommand1.ExecuteReader();
